...
public class QueryController {
    ...
    public Flux<ChatMessage> subscribeRoomMessages(@PathVariable String roomId) {
        ...
        SubscriptionQueryResult<List<ChatMessage>, ChatMessage> result = gateway.subscriptionQuery(query, multipleInstancesOf(ChatMessage.class), instanceOf(ChatMessage.class));
